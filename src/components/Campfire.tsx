    ...
    <div className="flex flex-col items-center gap-3">
      <div className="relative w-32 h-32 flex items-center justify-center">
        <motion.div
          ...
          style={{
            background: `radial-gradient(circle, hsla(210, 80%, 55%, ${fireScale * 0.3}) 0%, transparent 70%)`,
          }}
        ...
        <motion.div
          ...
          animate={{ scale: [fireScale, fireScale * 1.08, fireScale], y: [0, -3, 0] }}
        ...
        >
          ...
          {isStrong && (
            <motion.span className="text-3xl absolute -top-4" animate={{ y: [0, -8, 0], opacity: [0.6, 1, 0.6] }} transition={{ duration: 1, repeat: Infinity }}>
              ✨
            </motion.span>
          )}
        </motion.div>
      ...
      <div className="text-center">
        ...
        <div className="w-24 h-1.5 rounded-full bg-muted mt-2 mx-auto overflow-hidden">
          <motion.div className="h-full rounded-full gradient-fire" initial={{ width: 0 }} animate={{ width: `${level}%` }} transition={{ duration: 1, ease: "easeOut" }} />
        </div>
